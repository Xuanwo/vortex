...
//!
//! Point cases use 16,384 rows. Polygon distance rebuilds both geometry R-trees per call, so its
//! smaller fixture still exercises that work without making CodSpeed's amd64/AVX2 CPU simulation
//! dominate the shard.
...
const POINT_ROWS: usize = 16_384;
const POLYGON_ROWS: usize = 1_024;
