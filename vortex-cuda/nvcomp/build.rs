...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .header(include_dir.join("nvcomp/snappy.h").to_string_lossy())
        .clang_arg(format!("-I{}", include_dir.display()))
        .clang_arg(format!("-I{}", cuda_stub_dir.display()))
        .allowlist_type("nvcompStatus_t")
        .allowlist_type("nvcompAlignmentRequirements_t")
        .allowlist_type("nvcompBatchedZstdDecompressOpts_t")
        .allowlist_type("nvcompBatchedSnappyDecompressOpts_t")
        .allowlist_type("nvcompDecompressBackend_t")
        .allowlist_function("nvcompBatchedZstdDecompressGetTempSizeAsync")
        .allowlist_function("nvcompBatchedZstdDecompressGetRequiredAlignments")
        .allowlist_function("nvcompBatchedZstdDecompressAsync")
        .allowlist_function("nvcompBatchedSnappyDecompressGetTempSizeAsync")
        .allowlist_function("nvcompBatchedSnappyDecompressGetRequiredAlignments")
        .allowlist_function("nvcompBatchedSnappyDecompressAsync")
